...
LWR_Subcanopy_CLM_Cherskiy_HM = horzcat(LW_in_bc_CLM(EP1(1):EP1(end)),...
    LW_in_bc_CLM(EP2(1):EP2(end)));

save('MLRdata_Cherskiy_HM.mat','LAI_Cherskiy','PAI_Cherskiy','Hourly_Time_Cherskiy',...
    'Cosine_Solar_Angle_Cherskiy','SWR_Incoming_Cherskiy','LWR_Atmosphere_Cherskiy',...
    'Sky_Emissivity_Cherskiy','LWR_Subcanopy_Observations_Cherskiy','LWR_Subcanopy_CLM_Cherskiy_HM')