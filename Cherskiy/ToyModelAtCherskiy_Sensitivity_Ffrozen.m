...
%}
Fraction_Frozen_Soil = nan(11,1);
for j=1:11
    Fraction_Frozen_Soil(j) = min(1,max(0,(0.8+(j-1)*0.04)));
end
...
% call Driver
    ...
    SNOWPACKwithinCLM45driver(Latitude,Longitude,Elevation,JulDay(t),...
        ...
        Snow_Depth_Below_Vegetation(t),Snow_Fraction(t),Fraction_Frozen_Soil(j),...
...
save('LWsub_Cherskiy_Ffrozen.mat','LW_in_bc_1h','LW_in_bc_CLM','LW_in_bc_SP')
