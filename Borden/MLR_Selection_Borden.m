...
LWR_Subcanopy_CLM_Borden = horzcat(LW_in_bc_CLM_comb(EP_start:gap_LW_1(1)-1),...
...
save('MLRdata_Borden.mat','LAI_Borden','PAI_Borden','Hourly_Time_Borden',...
    'Cosine_Solar_Angle_Borden','SWR_Incoming_Borden','LWR_Atmosphere_Borden',...
    'Sky_Emissivity_Borden','LWR_Subcanopy_Observations_Borden','LWR_Subcanopy_CLM_Borden')