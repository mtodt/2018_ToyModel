...
marginal.
%}
    forc_sol_dir(1) = SW_In_Above_Vegetation(t)*(1-Diffuse_Fraction(t,j));
    forc_sol_dir(2) = 0;    % no nir radiation
    forc_sol_dif(1) = SW_In_Above_Vegetation(t)*Diffuse_Fraction(t,j);
...
save('LWsub_Borden_Fdiff.mat','LW_in_bc_1h','LW_in_bc_CLM_comb','LW_in_bc_SP')
