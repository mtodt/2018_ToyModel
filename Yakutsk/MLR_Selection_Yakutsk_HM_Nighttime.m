...
LWR_Subcanopy_CLM_Yakutsk_HM = vertcat(LW_in_bc_CLM_98(EP_98_1(1):EP_98_1(end)),...
...
for l=1:length(SWR_Incoming_Yakutsk)
    if SWR_Incoming_Yakutsk(l) == 0
        ...
        LWR_Subcanopy_CLM_Yakutsk_HM_Night(i) =  LWR_Subcanopy_CLM_Yakutsk_HM(l);
    end
end

save('MLRdata_Yakutsk_HM.mat','LAI_Yakutsk','PAI_Yakutsk','Hourly_Time_Yakutsk_Night',...
    'Cosine_Solar_Angle_Yakutsk_Night','SWR_Incoming_Yakutsk_Night',...
    'LWR_Atmosphere_Yakutsk_Night','Sky_Emissivity_Yakutsk_Night',...
    'LWR_Subcanopy_Observations_Yakutsk_Night','LWR_Subcanopy_CLM_Yakutsk_HM_Night')