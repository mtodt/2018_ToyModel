...
% ground
Soil_Water = nan(length(GWL),11);
for j=1:11
    Soil_Water(:,j) = min(1,max(0,(0.8+(j-1)*0.04)*GWL));
end
% Soil_Water = GWL;
%{
...
% call Driver
        ...
        SNOWPACKwithinCLM45driver(Latitude,Longitude,Elevation,JulDay(t),...
            ...
            Sand_Fraction,Clay_Fraction,Fraction_Organic_Matter,Soil_Water(t,j),...
            SoilWaterFlag,CanWetFrac(t-1,i),CanInt(t-1,i));
    end
end
end

save('LWsub_Abisko_SWC.mat','LW_in_bc_C_1h','LW_in_bc_CLM','LW_in_bc_SP')
toc