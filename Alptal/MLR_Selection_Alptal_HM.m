...
LWR_Subcanopy_CLM_Alptal_2004_HM = vertcat(LW_in_bc_CLM(EP_2004(1):gap_2004_1(1)-1,1),...
...
LWR_Subcanopy_CLM_Alptal_2005_HM = vertcat(LW_in_bc_CLM(EP_2005(1):gap_2005_1(1)-1,2),...
...
LWR_Subcanopy_CLM_Alptal_2006_HM = vertcat(LW_in_bc_CLM(EP_2006(1):gap_2006(1)-1,3),...
...
LWR_Subcanopy_CLM_Alptal_2007_HM = vertcat(LW_in_bc_CLM(EP_2007(1):gap_2007_1(1)-1,4),...
    LW_in_bc_CLM(gap_2007_1(end)+1:gap_2007_2(1)-1,4),...
    LW_in_bc_CLM(gap_2007_2(end)+1:EP_2007(end),4));


save('MLRdata_Alptal_HM.mat','LAI_Alptal','PAI_Alptal','Hourly_Time_Alptal_2004',...
    ...
    'LWR_Subcanopy_CLM_Alptal_2004_HM','LWR_Subcanopy_CLM_Alptal_2005_HM',...
    'LWR_Subcanopy_CLM_Alptal_2006_HM','LWR_Subcanopy_CLM_Alptal_2007_HM')