...
LWR_Subcanopy_CLM_Sodankyla_HM = vertcat(LW_in_bc_CLM(EP1(1):EP1(end),:),...
    LW_in_bc_CLM(EP2(1):EP2(end),:));


save('MLRdata_Sodankyla_HM.mat','LAI_Sodankyla','PAI_Sodankyla','Hourly_Time_Sodankyla',...
    'Cosine_Solar_Angle_Sodankyla','SWR_Incoming_Sodankyla','LWR_Atmosphere_Sodankyla',...
    'Sky_Emissivity_Sodankyla','LWR_Subcanopy_Observations_Sodankyla','LWR_Subcanopy_CLM_Sodankyla_HM')