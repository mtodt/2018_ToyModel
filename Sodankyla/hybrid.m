function [x0,gs_mol,an] = hybrid(x0,gb_mol,je,cair,oair,lmr_z,par_z,...
    rh_can,tpu_z,vcmax_z,kp_z,bbb,mbb,forc_pbot,t_veg)
%{
...
[f0,gs_mol,an] = ci_func(x0,gb_mol,je,cair,oair,lmr_z,par_z,rh_can,tpu_z,...
    vcmax_z,kp_z,bbb,mbb,forc_pbot,t_veg);
...
if f0 == 0
   x0 = x0;
    ...
    minf = f0;
    x1 = x0*0.99;
    [f1,gs_mol,an] = ci_func(x1,gb_mol,je,cair,oair,lmr_z,par_z,rh_can,...
        tpu_z,vcmax_z,kp_z,bbb,mbb,forc_pbot,t_veg);
    ...
    if f1 == 0
        ...
        while iter <= itmax
            ...
            f0 = f1;
            x1 = x;
            [f1,gs_mol,an] = ci_func(x1,gb_mol,je,cair,oair,lmr_z,par_z,...
                rh_can,tpu_z,vcmax_z,kp_z,bbb,mbb,forc_pbot,t_veg);
            ...
            if f1*f0 < 0
                [x,gs_mol,an] = brent(x0,x1,f0,f1,tol,gb_mol,je,cair,...
                    oair,lmr_z,par_z,rh_can,tpu_z,vcmax_z,kp_z,bbb,mbb,...
                    forc_pbot,t_veg,gs_mol,an);
                x0 = x;
                break
            end
            ...
            %}
                [f1,gs_mol,an] = ci_func(minx,gb_mol,je,cair,oair,...
                    lmr_z,par_z,rh_can,tpu_z,vcmax_z,kp_z,bbb,mbb,...
                    forc_pbot,t_veg);
                break
            end
        end
