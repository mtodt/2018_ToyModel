...
Diffuse_Fraction = nan(length(r_SW_FluxNet_1h),11);
for j=1:11
    Diffuse_Fraction(:,j) = min(1,max(0,(0.8+(j-1)*0.04)*(1-r_SW_FluxNet_1h)));
end
...
save('LWsub_Seehornwald_Fdiff.mat','LW_in_bc_1h','LW_in_bc_CLM','LW_in_bc_SP')
toc